  ...
  return (
    <>
      ...
      <div
        ref={sidebarRef}
        id="mobile-sidebar"
        className={`fixed top-0 right-0 w-full h-full sm:w-80 bg-naval-blue z-50 lg:hidden transform transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "translate-x-full"
          }`}
      >
